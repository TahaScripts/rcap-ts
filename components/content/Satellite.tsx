...
export default function Satellite({parallax, header, copy} : Props) {
    ...
    return (
      ...
      <div className="mt-10 md:mt-[20vh] w-full grid grid-cols-1 lg:grid-cols-2 gap-10 gap-y-20 md:gap-y-[20vh]">
          ...
          <div className="col col-span-1 lg:col-span-2">
            <m.div style={{y:parallax}} className="w-full h-full group overflow-scroll max-w-full md:overflow-visible md:flex items-center justify-center">
